...
![диаграмма](images/диаграмма_Дро_покер.drawio.png)

| Название прецедента     | Начало игры |
|:------------------------|:------------|
| Описание                | Для того, чтобы начать игру, игрок должен внести небольшой взнос (анте).|
| Основной исполнитель    | Игрок.|
| Основной сценарий       | 1. Игрок выбирает стол с удовлетворяющим взносом за вход;<br>2. Игрок вносит анте.|
| Альтернативный сценарий | Если у игрока количество фишек меньше, чем первоначальный взнос на выбранном столе, то система предлагает ему изменить выбор или покинуть игру;<br>Если игрок не внес анте, то он не принимает участие в игре.|
